...
> This is a console app that allows users to manage collections of the things they own. The app allows:

- Add new items.
- Show selected items.
- Preserve user data by saving collections in .json files.
